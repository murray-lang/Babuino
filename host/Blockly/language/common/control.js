...
Blockly.Language.controls_loop = {
  // Repeat forever.
  helpUrl: Blockly.LANG_CONTROLS_LOOP_HELPURL,
  init: function() {
    this.setColour(120);
    this.appendDummyInput()
        .appendTitle(Blockly.LANG_CONTROLS_LOOP_TITLE);
     this.appendStatementInput('DO');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.LANG_CONTROLS_LOOP_TOOLTIP);
  }
};
