...
switch( state )
{
	case 0:
		...
		else if( ( info.src.charCodeAt( pos ) >= 49 && info.src.charCodeAt( pos ) <= 57 ) ) state = 89;
		else if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 92;
		else if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 93;
		else if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 94;
		...
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 97;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 98;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 99;
		else if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 100;
		...
		else if( info.src.charCodeAt( pos ) == 83 ) state = 104;
		...
		else if( info.src.charCodeAt( pos ) == 88 || info.src.charCodeAt( pos ) == 120 ) state = 222;
		else if( info.src.charCodeAt( pos ) == 115 ) state = 276;
		else state = -1;
		break;
	...
	case 2:
		...
		else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) ) state = 89;
		else if( info.src.charCodeAt( pos ) == 98 ) state = 107;
	...
	case 7:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 143;
		else state = -1;
		match = 63;
		match_pos = pos;
		break;
	...
	case 10:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 247;
		else state = -1;
		match = 62;
		match_pos = pos;
		break;
	...
	case 12:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 227;
		else state = -1;
		match = 64;
		match_pos = pos;
		break;
	...
	case 13:
		if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 229;
		else state = -1;
		match = 45;
		match_pos = pos;
		break;
	...
	case 28:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 39;
		else state = -1;
		match = 57;
		match_pos = pos;
		break;
	...
	case 41:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 195;
		else state = -1;
		match = 16;
		match_pos = pos;
		break;
	...
	case 58:
		if( info.src.charCodeAt( pos ) == 88 || info.src.charCodeAt( pos ) == 120 ) state = 211;
		else state = -1;
		match = 22;
		match_pos = pos;
		break;
	...
	case 66:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 72;
		else state = -1;
		match = 55;
		match_pos = pos;
		break;
	...
	case 88:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 110;
		...
		else if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 223;
		else state = -1;
		break;
	...
	case 90:
		if( ( info.src.charCodeAt( pos ) >= 49 && info.src.charCodeAt( pos ) <= 56 ) ) state = 76;
		else state = -1;
		match = 79;
		match_pos = pos;
		break;
	...
	case 91:
		if( ( info.src.charCodeAt( pos ) >= 49 && info.src.charCodeAt( pos ) <= 56 ) ) state = 77;
		else state = -1;
		match = 80;
		match_pos = pos;
		break;
	...
	case 92:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 113;
		else if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 114;
		else if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 221;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 245;
		else state = -1;
		break;
	...
	case 102:
		...
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 246;
		else state = -1;
		break;
	...
	case 104:
		...
		else if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 130;
		else if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 225;
		else state = -1;
		break;

	case 105:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 131;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 132;
		else state = -1;
		break;

	case 106:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 133;
		else if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 226;
		else state = -1;
		break;
	...
	case 113:
		...
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 248;
		else state = -1;
		break;
	...
	case 115:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 141;
		else state = -1;
		break;
	...
	case 125:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 149;
		else state = -1;
		break;

	case 126:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 150;
		else if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 151;
	...
	case 127:
		...
		else if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 260;
		else state = -1;
		break;

	case 128:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 27;
		else state = -1;
		break;
	...
	case 132:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 252;
		else state = -1;
		break;

	case 133:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 158;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 228;
		else state = -1;
		break;
	...
	case 139:
		if( info.src.charCodeAt( pos ) == 75 || info.src.charCodeAt( pos ) == 107 ) state = 161;
		else state = -1;
		break;
	...
	case 141:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 35;
		else state = -1;
		break;

	case 142:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 162;
		else state = -1;
		break;

	case 143:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 164;
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 250;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 251;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 261;
		else state = -1;
		break;
	...
	case 145:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 165;
		else state = -1;
		break;
	...
	case 147:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 232;
		else state = -1;
		break;

	case 148:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 231;
		else state = -1;
		break;

	case 149:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 168;
		else state = -1;
		break;
	...
	case 151:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 235;
		else state = -1;
		break;

	case 152:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 262;
		else state = -1;
		break;
	...
	case 154:
		...
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 171;
		else if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 234;
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 237;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 256;
		else if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 263;
		else state = -1;
		break;

	case 155:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 172;
		else state = -1;
		break;

	case 156:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 173;
		else state = -1;
		break;

	case 157:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 41;
		else state = -1;
		break;
	...
	case 160:
		if( info.src.charCodeAt( pos ) == 75 || info.src.charCodeAt( pos ) == 107 ) state = 44;
		else state = -1;
		break;

	case 161:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 45;
		else state = -1;
		break;
	...
	case 163:
		if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 238;
		else state = -1;
		break;

	case 164:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 177;
		else state = -1;
		break;
	...
	case 166:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 47;
		else if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 180;
		else state = -1;
		break;
	...
	case 168:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 183;
		else state = -1;
		break;
	...
	case 170:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 50;
		else state = -1;
		break;
	...
	case 173:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 193;
		else state = -1;
		break;

	case 174:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 194;
		else state = -1;
		break;
	...
	case 177:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 264;
		else state = -1;
		break;

	case 178:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 200;
		else state = -1;
		break;
	...
	case 180:
		if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 55;
		else state = -1;
		break;

	case 181:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 56;
		else state = -1;
		break;

	case 182:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 57;
		else state = -1;
		break;

	case 183:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 58;
		else state = -1;
		break;

	case 184:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 59;
		else state = -1;
		break;

	case 185:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 60;
		else state = -1;
		break;
	...
	case 187:
		...
		else if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 202;
		else state = -1;
		break;
	...
	case 189:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 64;
		else state = -1;
		break;

	case 190:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 65;
		else state = -1;
		break;

	case 191:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 272;
		else state = -1;
		break;

	case 192:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 66;
		else state = -1;
		break;

	case 193:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 67;
		else state = -1;
		break;

	case 194:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 205;
		else state = -1;
		break;

	case 195:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 207;
		else state = -1;
		break;

	case 196:
		if( info.src.charCodeAt( pos ) == 82 ) state = 64;
		else if( info.src.charCodeAt( pos ) == 114 ) state = 90;
		else state = -1;
		break;

	case 197:
		if( info.src.charCodeAt( pos ) == 72 ) state = 67;
		else if( info.src.charCodeAt( pos ) == 104 ) state = 91;
		else state = -1;
		break;
	...
	case 199:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 208;
		else state = -1;
		break;

	case 200:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 69;
		else state = -1;
		break;

	case 201:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 244;
		else state = -1;
		break;

	case 202:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 70;
		else state = -1;
		break;

	case 203:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 213;
		else state = -1;
		break;
	...
	case 205:
		if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 74;
		else state = -1;
		break;

	case 206:
		if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 75;
		else state = -1;
		break;

	case 207:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 214;
		else state = -1;
		break;

	case 208:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 215;
		else state = -1;
		break;

	case 209:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 78;
		else state = -1;
		break;

	case 210:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 79;
		else state = -1;
		break;
	...
	case 212:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 81;
		else state = -1;
		break;

	case 213:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 82;
		else state = -1;
		break;

	case 214:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 218;
		else state = -1;
		break;

	case 215:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 83;
		else state = -1;
		break;
	...
	case 219:
		if( info.src.charCodeAt( pos ) == 63 ) state = 86;
		else if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 220;
		else state = -1;
		break;

	case 220:
		if( info.src.charCodeAt( pos ) == 63 ) state = 87;
		else state = -1;
		break;
	...
	case 223:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 136;
		else state = -1;
		break;

	case 224:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 144;
		else state = -1;
		break;
	...
	case 228:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 176;
		else state = -1;
		break;

	case 229:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 167;
		else state = -1;
		break;
	...
	case 231:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 182;
		else state = -1;
		break;

	case 232:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 181;
		else state = -1;
		break;

	case 233:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 174;
		else state = -1;
		break;

	case 234:
		if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 192;
		else state = -1;
		break;

	case 235:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 186;
		else state = -1;
		break;
	...
	case 238:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 198;
		else state = -1;
		break;

	case 239:
		if( info.src.charCodeAt( pos ) == 67 ) state = 193;
		else if( info.src.charCodeAt( pos ) == 99 ) state = 197;
		else state = -1;
		break;

	case 240:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 203;
		else state = -1;
		break;

	case 241:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 201;
		else state = -1;
		break;

	case 242:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 204;
		else state = -1;
		break;

	case 243:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 206;
		else state = -1;
		break;
	...
	case 245:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 138;
		else state = -1;
		break;
	...
	case 248:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 159;
		else state = -1;
		break;

	case 249:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 271;
		else state = -1;
		break;

	case 250:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 268;
		else state = -1;
		break;

	case 251:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 257;
		else state = -1;
		break;

	case 252:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 175;
		else state = -1;
		break;

	case 253:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 185;
		else state = -1;
		break;

	case 254:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 187;
		else state = -1;
		break;

	case 255:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 190;
		else state = -1;
		break;

	case 256:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 273;
		else state = -1;
		break;

	case 257:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 258;
		else state = -1;
		break;

	case 258:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 209;
		else state = -1;
		break;
	...
	case 260:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 255;
		else state = -1;
		break;
	...
	case 263:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 240;
		else state = -1;
		break;
	...
	case 266:
		if( info.src.charCodeAt( pos ) == 79 ) state = 189;
		else if( info.src.charCodeAt( pos ) == 111 ) state = 196;
		else state = -1;
		break;

	case 267:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 212;
		else state = -1;
		break;

	case 268:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 199;
		else state = -1;
		break;

	case 269:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 38;
		else if( info.src.charCodeAt( pos ) == 83 ) state = 236;
		else if( info.src.charCodeAt( pos ) == 115 ) state = 266;
		else state = -1;
		break;

	case 270:
		if( info.src.charCodeAt( pos ) == 84 ) state = 173;
		else if( info.src.charCodeAt( pos ) == 116 ) state = 239;
		else state = -1;
		break;

	case 271:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 243;
		else state = -1;
		break;

	case 272:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 259;
		else state = -1;
		break;

	case 273:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 267;
		else state = -1;
		break;

	case 274:
		if( info.src.charCodeAt( pos ) == 78 ) state = 153;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 154;
		else if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 260;
		else if( info.src.charCodeAt( pos ) == 110 ) state = 269;
		else state = -1;
		break;

	case 275:
		if( info.src.charCodeAt( pos ) == 73 ) state = 156;
		else if( info.src.charCodeAt( pos ) == 105 ) state = 270;
		else state = -1;
		break;

	case 276:
		if( info.src.charCodeAt( pos ) == 69 ) state = 127;
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 128;
		else if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 129;
		else if( info.src.charCodeAt( pos ) == 87 ) state = 130;
		else if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 225;
		else if( info.src.charCodeAt( pos ) == 101 ) state = 274;
		else if( info.src.charCodeAt( pos ) == 119 ) state = 275;
		else state = -1;
		break;
...
switch( match )
{
	...
	case 79:
		{
		 info.att = 147; /* sensor number is provided by the previous short */
		}
		break;

	case 80:
		{
		 info.att = 148; /* switch number is provided by the previous short */
		}
		break;
...
var pop_tab = new Array(
	...
	new Array( 90/* Cmd */, 1 ),
	new Array( 90/* Cmd */, 1 ),
	new Array( 92/* BinaryCmd */, 2 ),
	new Array( 92/* BinaryCmd */, 2 ),
	new Array( 92/* BinaryCmd */, 2 ),
	new Array( 91/* UnaryCmd */, 1 ),
	new Array( 91/* UnaryCmd */, 1 ),
	new Array( 91/* UnaryCmd */, 1 ),
	new Array( 91/* UnaryCmd */, 1 ),
	new Array( 91/* UnaryCmd */, 1 ),
