...
/*
  var currScriptEl = document.currentScript;
  
  var nextScriptEl = document.createElement("script");
  nextScriptEl.setAttribute("type", "text/javascript");
  nextScriptEl.setAttribute("src", BLOCKLY_DIR + "/../closure-library-read-only/closure/goog/base.js");
  currScriptEl.parentNode.appendChild(nextScriptEl);
  
  nextScriptEl = document.createElement("script");
  nextScriptEl.setAttribute("type", "text/javascript");
  nextScriptEl.setAttribute("src", BLOCKLY_DIR + "/blockly_core_deps.js");
  currScriptEl.parentNode.appendChild(nextScriptEl);
  
  nextScriptEl = document.createElement("script");
  nextScriptEl.setAttribute("type", "text/javascript");
  nextScriptEl.setAttribute("src", BLOCKLY_DIR + "/googrequireblocklycore.js");
  currScriptEl.parentNode.appendChild(nextScriptEl);
  */
})();
