...
switch( state )
{
	case 0:
		...
		else if( info.src.charCodeAt( pos ) == 45 ) state = 94;
		else if( ( info.src.charCodeAt( pos ) >= 49 && info.src.charCodeAt( pos ) <= 57 ) ) state = 95;
		...
		else if( info.src.charCodeAt( pos ) == 88 || info.src.charCodeAt( pos ) == 120 ) state = 243;
		else if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 244;
		else state = -1;
		break;
	...
	case 2:
		...
		else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) ) state = 95;
		else if( info.src.charCodeAt( pos ) == 98 ) state = 114;
		else if( info.src.charCodeAt( pos ) == 120 ) state = 115;
		else state = -1;
		match = 89;
		match_pos = pos;
		break;
	...
	case 3:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 116;
		else state = -1;
		match = 93;
		match_pos = pos;
		break;
	...
	case 5:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 155;
		else state = -1;
		match = 60;
		match_pos = pos;
		break;
	...
	case 9:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 159;
		else state = -1;
		match = 10;
		match_pos = pos;
		break;
	...
	case 10:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 160;
		else if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 270;
		else state = -1;
		match = 62;
		match_pos = pos;
		break;
	...
	case 12:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 271;
		else state = -1;
		match = 64;
		match_pos = pos;
		break;
	...
	case 13:
		if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 254;
		else state = -1;
		match = 45;
		match_pos = pos;
		break;
	...
	case 24:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 253;
		else state = -1;
		match = 71;
		match_pos = pos;
		break;
	...
	case 44:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 57;
		else state = -1;
		match = 19;
		match_pos = pos;
		break;
	...
	case 47:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 214;
		else state = -1;
		match = 16;
		match_pos = pos;
		break;
	...
	case 66:
		if( info.src.charCodeAt( pos ) == 88 || info.src.charCodeAt( pos ) == 120 ) state = 232;
		else state = -1;
		match = 22;
		match_pos = pos;
		break;
	...
	case 96:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 117;
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 118;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 119;
		else if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 120;
		else if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 121;
		else if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 245;
		else state = -1;
		break;
	...
	case 98:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 122;
		else if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 123;
		else if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 242;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 268;
		else state = -1;
		break;
	...
	case 101:
		...
		else if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 127;
		else if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 246;
		else state = -1;
		break;
	...
	case 103:
		...
		else if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 269;
		else state = -1;
		break;
	...
	case 106:
		...
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 131;
		else state = -1;
		break;
	...
	case 108:
		...
		else if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 133;
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 282;
		else state = -1;
		break;
	...
	case 109:
		...
		else if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 137;
		else state = -1;
		break;

	case 110:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 138;
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 139;
		else if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 140;
		else if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 247;
		else state = -1;
		break;

	case 111:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 141;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 142;
		else state = -1;
		break;

	case 112:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 143;
		else if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 144;
		else state = -1;
		break;

	case 113:
		if( info.src.charCodeAt( pos ) == 69 ) state = 138;
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 139;
		else if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 140;
		else if( info.src.charCodeAt( pos ) == 119 ) state = 146;
		else if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 247;
	...
	case 119:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 19;
		else state = -1;
		break;
	...
	case 121:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 148;
		else state = -1;
		break;

	case 122:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 150;
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 250;
		else state = -1;
		break;

	case 123:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 153;
		else state = -1;
		break;

	case 124:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 154;
		else state = -1;
		break;

	case 125:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 21;
		else if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 22;
		else state = -1;
		break;

	case 126:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 23;
		else state = -1;
		break;

	case 127:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 248;
		else state = -1;
		break;

	case 128:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 24;
		else state = -1;
		break;

	case 129:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 161;
		else state = -1;
		break;

	case 130:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 25;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 162;
		else state = -1;
		break;

	case 131:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 26;
		else state = -1;
		break;

	case 132:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 27;
		else state = -1;
		break;

	case 133:
		if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 28;
		else state = -1;
		break;

	case 134:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 29;
		else state = -1;
		break;
	...
	case 136:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 165;
		else state = -1;
		break;

	case 137:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 166;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 167;
		else if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 251;
		else if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 273;
		else state = -1;
		break;

	case 138:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 168;
	...
	case 139:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 30;
		else state = -1;
		break;

	case 140:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 31;
		else if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 32;
		else state = -1;
		break;

	case 141:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 171;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 172;
		else state = -1;
		break;

	case 142:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 283;
		else state = -1;
		break;
	...
	case 144:
		...
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 252;
		else state = -1;
		break;

	case 145:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 33;
		else state = -1;
		break;

	case 146:
		if( info.src.charCodeAt( pos ) == 105 ) state = 176;
		else state = -1;
		break;

	case 147:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 34;
		else state = -1;
		break;
	...
	case 149:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 36;
		else state = -1;
		break;
	...
	case 151:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 178;
		else state = -1;
		break;

	case 152:
		if( info.src.charCodeAt( pos ) == 75 || info.src.charCodeAt( pos ) == 107 ) state = 179;
		else state = -1;
		break;

	case 153:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 38;
		else state = -1;
		break;

	case 154:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 39;
		else state = -1;
		break;
	...
	case 156:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 180;
		else state = -1;
		break;

	case 157:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 182;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 183;
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 274;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 275;
		else state = -1;
		break;
	...
	case 159:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 258;
		else state = -1;
		break;

	case 160:
		if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 184;
		else state = -1;
		break;
	...
	case 163:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 255;
		else state = -1;
		break;

	case 164:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 43;
		else state = -1;
		break;

	case 165:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 187;
		else state = -1;
		break;
	...
	case 167:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 284;
		else state = -1;
		break;

	case 168:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 44;
		else state = -1;
		break;

	case 169:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 189;
		else if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 190;
		else if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 261;
		else if( info.src.charCodeAt( pos ) == 71 || info.src.charCodeAt( pos ) == 103 ) state = 262;
		else if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 279;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 288;
		else state = -1;
		break;

	case 170:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 191;
		else state = -1;
		break;

	case 171:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 192;
		else state = -1;
		break;

	case 172:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 289;
		else state = -1;
		break;

	case 173:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 47;
		else state = -1;
		break;

	case 174:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 48;
		else state = -1;
		break;

	case 175:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 44;
		else if( info.src.charCodeAt( pos ) == 115 ) state = 195;
		else state = -1;
		break;

	case 176:
		if( info.src.charCodeAt( pos ) == 116 ) state = 196;
		else state = -1;
		break;
	...
	case 182:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 198;
		else state = -1;
		break;
	...
	case 185:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 55;
		else if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 201;
		else state = -1;
		break;
	...
	case 188:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 205;
		else state = -1;
		break;

	case 189:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 58;
		else state = -1;
		break;

	case 190:
		if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 212;
		else state = -1;
		break;
	...
	case 192:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 213;
		else state = -1;
		break;

	case 193:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 60;
		else state = -1;
		break;
	...
	case 195:
		if( info.src.charCodeAt( pos ) == 111 ) state = 215;
		else state = -1;
		break;

	case 196:
		if( info.src.charCodeAt( pos ) == 99 ) state = 216;
		else state = -1;
		break;

	case 197:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 280;
		else state = -1;
		break;

	case 198:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 286;
		else state = -1;
		break;

	case 199:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 219;
		else state = -1;
		break;
	...
	case 201:
		if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 63;
		else state = -1;
		break;
	...
	case 204:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 66;
		else state = -1;
		break;

	case 205:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 67;
		else state = -1;
		break;

	case 206:
		if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 68;
		else state = -1;
		break;
	...
	case 208:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 70;
		else if( info.src.charCodeAt( pos ) == 68 || info.src.charCodeAt( pos ) == 100 ) state = 221;
		else state = -1;
		break;

	case 209:
		if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 71;
		else state = -1;
		break;

	case 210:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 72;
		else state = -1;
		break;
	...
	case 212:
		if( info.src.charCodeAt( pos ) == 72 || info.src.charCodeAt( pos ) == 104 ) state = 73;
		else state = -1;
		break;

	case 213:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 224;
		else state = -1;
		break;
	...
	case 215:
		if( info.src.charCodeAt( pos ) == 114 ) state = 227;
		else state = -1;
		break;

	case 216:
		if( info.src.charCodeAt( pos ) == 104 ) state = 228;
		else state = -1;
		break;
	...
	case 218:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 229;
		else state = -1;
		break;

	case 219:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 75;
		else state = -1;
		break;

	case 220:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 267;
		else state = -1;
		break;

	case 221:
		if( info.src.charCodeAt( pos ) == 80 || info.src.charCodeAt( pos ) == 112 ) state = 76;
		else state = -1;
		break;

	case 222:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 234;
		else state = -1;
		break;
	...
	case 224:
		if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 80;
		else state = -1;
		break;

	case 225:
		if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 81;
		else state = -1;
		break;

	case 226:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 235;
		else state = -1;
		break;

	case 227:
		if( ( info.src.charCodeAt( pos ) >= 49 && info.src.charCodeAt( pos ) <= 56 ) ) state = 82;
		else state = -1;
		break;

	case 228:
		if( ( info.src.charCodeAt( pos ) >= 49 && info.src.charCodeAt( pos ) <= 56 ) ) state = 83;
		else state = -1;
		break;

	case 229:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 236;
		else state = -1;
		break;

	case 230:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 84;
		else state = -1;
		break;

	case 231:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 85;
		else state = -1;
		break;

	case 232:
		if( info.src.charCodeAt( pos ) == 89 || info.src.charCodeAt( pos ) == 121 ) state = 86;
		else state = -1;
		break;
	...
	case 234:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 88;
		else state = -1;
		break;

	case 235:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 239;
		else state = -1;
		break;
	...
	case 237:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 240;
		else state = -1;
		break;

	case 238:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 90;
		else state = -1;
		break;
	...
	case 240:
		if( info.src.charCodeAt( pos ) == 63 ) state = 92;
		else if( info.src.charCodeAt( pos ) == 78 || info.src.charCodeAt( pos ) == 110 ) state = 241;
		else state = -1;
		break;

	case 241:
		if( info.src.charCodeAt( pos ) == 63 ) state = 93;
		else state = -1;
		break;

	case 242:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 152;
		else state = -1;
		break;

	case 243:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 145;
		else state = -1;
		break;

	case 244:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 134;
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 135;
		else state = -1;
		break;

	case 245:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 149;
		else state = -1;
		break;
	...
	case 248:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 181;
		else state = -1;
		break;

	case 249:
		if( info.src.charCodeAt( pos ) == 78 ) state = 168;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 169;
	...
	case 250:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 177;
		else state = -1;
		break;

	case 251:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 259;
		else state = -1;
		break;

	case 252:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 194;
		else state = -1;
		break;

	case 253:
		if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 278;
		else state = -1;
		break;

	case 254:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 186;
		else state = -1;
		break;

	case 255:
		if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 203;
		else state = -1;
		break;

	case 256:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 202;
		else state = -1;
		break;

	case 257:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 208;
		else state = -1;
		break;

	case 258:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 200;
		else state = -1;
		break;

	case 259:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 207;
		else state = -1;
		break;

	case 260:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 264;
		else state = -1;
		break;

	case 261:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 290;
		else state = -1;
		break;

	case 262:
		if( info.src.charCodeAt( pos ) == 76 || info.src.charCodeAt( pos ) == 108 ) state = 211;
		else state = -1;
		break;

	case 263:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 222;
		else state = -1;
		break;
	...
	case 265:
		if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 223;
		else state = -1;
		break;

	case 266:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 225;
		else state = -1;
		break;

	case 267:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 237;
		else state = -1;
		break;

	case 268:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 151;
		else state = -1;
		break;
	...
	case 270:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 185;
		else state = -1;
		break;

	case 271:
		if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 260;
		else state = -1;
		break;

	case 272:
		if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 277;
		else state = -1;
		break;

	case 273:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 257;
		else state = -1;
		break;
	...
	case 275:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 197;
		else state = -1;
		break;

	case 276:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 206;
		else state = -1;
		break;

	case 277:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 210;
		else state = -1;
		break;
	...
	case 279:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 263;
		else state = -1;
		break;
	...
	case 282:
		if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 163;
		else state = -1;
		break;
	...
	case 284:
		if( info.src.charCodeAt( pos ) == 82 || info.src.charCodeAt( pos ) == 114 ) state = 209;
		else state = -1;
		break;

	case 285:
		if( info.src.charCodeAt( pos ) == 79 || info.src.charCodeAt( pos ) == 111 ) state = 218;
		else state = -1;
		break;

	case 286:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 231;
		else state = -1;
		break;

	case 287:
		if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 233;
		else state = -1;
		break;

	case 288:
		if( info.src.charCodeAt( pos ) == 69 || info.src.charCodeAt( pos ) == 101 ) state = 265;
		else state = -1;
		break;

	case 289:
		if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 266;
		else state = -1;
		break;

	case 290:
		if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 287;
		else state = -1;
		break;

	case 291:
		if( info.src.charCodeAt( pos ) == 66 || info.src.charCodeAt( pos ) == 98 ) state = 281;
		else state = -1;
		break;
...
switch( match )
{
	...
	case 79:
		{
		 info.att = 148; /* analog input number is provided by the previous short */
		}
		break;

	case 80:
		{
		 info.att = 149; /* analog output number is provided by the previous short */
	...
	case 81:
		{
		 info.att = 150; /* digital input number is provided by the previous short */
		}
		break;

	case 82:
		{
		 info.att = 151; /* digital output number is provided by the previous short */
...
var pop_tab = new Array(
	...
	new Array( 94/* Program */, 2 ),
	new Array( 94/* Program */, 0 ),
	new Array( 95/* Stmt */, 2 ),
	new Array( 95/* Stmt */, 1 ),
	new Array( 96/* Cmd */, 1 ),
	new Array( 96/* Cmd */, 1 ),
	new Array( 98/* BinaryCmd */, 2 ),
	new Array( 98/* BinaryCmd */, 2 ),
	new Array( 98/* BinaryCmd */, 2 ),
	new Array( 97/* UnaryCmd */, 1 ),
	new Array( 97/* UnaryCmd */, 1 ),
	new Array( 97/* UnaryCmd */, 1 ),
	new Array( 97/* UnaryCmd */, 1 ),
	new Array( 97/* UnaryCmd */, 1 ),
